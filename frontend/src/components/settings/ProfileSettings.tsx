function ProfileSettings() {
  return (
    <section className="mt-4 w-full md:w-2/3">
      ...
      <p className="text-gray-500 text-sm -mt-1">Here's your account details</p>
      <form className="mt-2">
        <fieldset className=" rounded-tr-xl rounded-tl-xl border-2 p-4 pt-5 border-b-0 flex justify-start gap-4">
          ...
          <div className="flex flex-col justify-end w-2/3">
            <input type="text" disabled className="border-2 p-1 rounded-md " />
        ...
        <fieldset className="  border-2 p-4  border-b-0 flex justify-start gap-4">
          ...
          <div className="flex flex-col justify-end w-2/3">
            <input type="text" className="border-2 p-1 rounded-md " />
            <span className="text-sm text-gray-400">
        ...
        <fieldset className=" border-2 p-4 flex justify-start gap-7 border-b-0">
          ...
          <div className="flex flex-col justify-end w-2/3">
            <select disabled className="p-2 rounded" name="role" id="role">
